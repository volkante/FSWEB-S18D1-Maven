...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT o.sinif, COUNT(i.ogrno) FROM ogrenci AS o INNER JOIN islem AS i ON o.ogrno = i.ogrno WHERE sinif IN ('10A', '10B') GROUP BY o.sinif";
    ...
    //--Ali: 2, Mehmet: 3
    String QUESTION_7 = "SELECT DISTINCT ad, COUNT(ogrno) FROM ogrenci GROUP BY ad;";
